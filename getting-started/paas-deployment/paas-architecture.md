...
<table data-header-hidden><thead><tr><th width="157.203125"></th><th></th><th></th><th width="159.671875"></th><th></th></tr></thead><tbody><tr><td><strong>Workload tier</strong></td><td><strong>Pipeline characteristics</strong></td><td><strong>GB/day per vCPU</strong></td><td><strong>GB/hr per vCPU</strong></td><td><strong>RAM per vCPU</strong></td></tr><tr><td>Tier 1 Pass-through</td><td>Simple routing and filter rules only. 1 input → 1 output. No transformation.</td><td>200</td><td>~8.3</td><td>2 GB</td></tr><tr><td>Tier 2 Standard (Recommended)</td><td>Typical production pipeline. Filter + tag + rewrite + PII redaction. 1 input → 2 outputs (e.g. SIEM + S3). Recommended planning baseline.</td><td>164</td><td>~6.8</td><td>2–4 GB</td></tr><tr><td>Tier 3 Enriched</td><td>Enrichment-heavy: lookup tables, attribute-based tagging, multi-destination SIEM routing with load balancing.</td><td>116</td><td>~4.8</td><td>4–6 GB</td></tr><tr><td>Tier 4 Complex</td><td>Heavy transformation: cryptographic hashing (SHA-256/AES), stateful aggregations, cross-event persistence, 3+ destinations, custom forwarders.</td><td>82</td><td>~3.4</td><td>6–8 GB</td></tr><tr><td>Tier 5 AI / LLM</td><td>LLM/AI observability: token tracking, prompt/response telemetry, real-time secret redaction, multi-tenant routing, high-cardinality metadata.</td><td>58</td><td>~2.4</td><td>8–12 GB</td></tr></tbody></table>
...
<table data-header-hidden><thead><tr><th></th><th width="251.0546875"></th><th width="130.3125"></th><th width="111.453125"></th><th></th></tr></thead><tbody><tr><td><strong>Workload tier</strong></td><td><strong>Pipeline characteristics</strong></td><td><strong>GB/day per vCPU</strong></td><td><strong>GB/hr per vCPU</strong></td><td><strong>RAM per vCPU</strong></td></tr><tr><td>Tier 1 Pass-through + Lake</td><td>Simple routing and filter only, with full InstaStore™ indexing. 1 input → Lake + 1 output.</td><td>60</td><td>~2.5</td><td>2–4 GB</td></tr><tr><td>Tier 2 Standard + Lake (Recommended)</td><td>Typical production: filter + tag + rewrite + PII redaction. InstaStore™ write + 1 downstream output. Recommended baseline for Lake deployments.</td><td>50</td><td>~2.1</td><td>4 GB</td></tr><tr><td>Tier 3 Enriched + Lake</td><td>Enrichment pipeline with Lake indexing: lookup tables, tagging, multi-destination routing plus InstaStore™.</td><td>37</td><td>~1.5</td><td>4–6 GB</td></tr><tr><td>Tier 4 Complex + Lake</td><td>Heavy transformation, crypto hashing, stateful aggregations, 3+ destinations, InstaStore™ indexing.</td><td>26</td><td>~1.1</td><td>6–8 GB</td></tr><tr><td>Tier 5 AI / LLM + Lake</td><td>Full AI/LLM observability stack with InstaStore™ indexing, prompt retention, and high-cardinality metadata.</td><td>19</td><td>~0.8</td><td>10–16 GB</td></tr></tbody></table>
...
<table data-header-hidden><thead><tr><th width="96.48828125"></th><th></th><th></th></tr></thead><tbody><tr><td><strong>Step</strong></td><td><strong>Calculation</strong></td><td><strong>Result</strong></td></tr><tr><td>1</td><td>Select workload tier</td><td>Tier 2 Standard: 164 GB/day per vCPU (PII masking, 2 destinations; adjusted from 200 GB/day Benchmark 1 base)</td></tr><tr><td>2</td><td>Apply multi-destination adjustment: 2 outputs → ×0.85</td><td>164 × 0.85 = 139 GB/day per vCPU (effective)</td></tr><tr><td>3</td><td>Calculate raw vCPUs: 5,000 GB/day ÷ 139 GB/day per vCPU</td><td>36 vCPUs</td></tr><tr><td>4</td><td>Apply 2× peak spike buffer: 36 vCPUs × 2</td><td>72 vCPUs for peak handling</td></tr><tr><td>5</td><td>Apply +20% node redundancy: 72 vCPUs × 1.2</td><td>87 vCPUs total provisioned capacity</td></tr><tr><td>6</td><td>Node sizing: Intel c7i.4xlarge (16 vCPUs, 32 GB RAM). Reserve 1 vCPU per node for OS → 15 usable per node. 87 ÷ 15 = 5.8</td><td>6× c7i.4xlarge worker nodes (96 usable vCPUs, 192 GB RAM)</td></tr><tr><td>7</td><td>RAM check: Tier 2 = 2–4 GB/vCPU. At 2 GB/vCPU: 15 vCPUs × 2 GB = 30 GB per node. c7i.4xlarge provides 32 GB.</td><td>RAM check passed. c7i.4xlarge sufficient for Tier 2 standard workload.</td></tr></tbody></table>
...
<table data-header-hidden><thead><tr><th width="92.66796875"></th><th></th><th></th></tr></thead><tbody><tr><td><strong>Step</strong></td><td><strong>Calculation</strong></td><td><strong>Result</strong></td></tr><tr><td>1</td><td>Select workload tier</td><td>Tier 2 Standard + Lake: 50 GB/day per vCPU (PII masking, 1 downstream output; adjusted from 60 GB/day Benchmark 2 base)</td></tr><tr><td>2</td><td>Apply multi-destination adjustment: 1 downstream output beyond Lake → ×0.85</td><td>50 × 0.85 = 42.5 GB/day per vCPU (effective)</td></tr><tr><td>3</td><td>Calculate raw vCPUs: 5,000 GB/day ÷ 42.5 GB/day per vCPU</td><td>117.6 → round up to 118 vCPUs</td></tr><tr><td>4</td><td>Apply 2× peak spike buffer: 118 vCPUs × 2</td><td>236 vCPUs for peak handling</td></tr><tr><td>5</td><td>Apply +20% node redundancy: 236 vCPUs × 1.2</td><td>283 vCPUs total provisioned capacity</td></tr><tr><td>6</td><td>Node sizing: Intel c7i.4xlarge (16 vCPUs, 32 GB RAM). 1 vCPU OS reserve → 15 usable. 283 ÷ 15 = 18.9</td><td>19× c7i.4xlarge worker nodes (304 usable vCPUs, 608 GB RAM)</td></tr><tr><td>7</td><td>RAM check: Tier 2 + Lake = 4 GB/vCPU. 15 vCPUs × 4 GB = 60 GB per node. c7i.4xlarge provides 32 GB.</td><td>Upgrade to c7i.8xlarge (32 vCPUs, 64 GB RAM) for RAM headroom. 304 ÷ 31 = 10 nodes.</td></tr><tr><td>8</td><td>Revised node count with c7i.8xlarge (31 usable vCPUs): 304 ÷ 31 = 10</td><td>10× c7i.8xlarge worker nodes (320 usable vCPUs, 640 GB RAM) — RAM verified.</td></tr></tbody></table>

<table data-header-hidden><thead><tr><th valign="top"></th></tr></thead><tbody><tr><td valign="top"><strong>Benchmark 1 vs. Benchmark 2 comparison:</strong> For the same 5 TB/day workload, Benchmark 1 (Flow only) requires 6× c7i.4xlarge nodes, while Benchmark 2 (Flow + Lake) requires 10× c7i.8xlarge nodes. The InstaStore™ write overhead reduces effective throughput by approximately 70% (200 vs. 60 GB/day base), which is expected given the full-indexing, infinite-retention architecture.</td></tr></tbody></table>
...
<table data-header-hidden><thead><tr><th width="88.45703125"></th><th></th><th></th></tr></thead><tbody><tr><td><strong>Step</strong></td><td><strong>Calculation</strong></td><td><strong>Result</strong></td></tr><tr><td>1</td><td>Select workload tier: enrichment + crypto hashing + 3 destinations</td><td>Tier 3 Enriched: 116 GB/day per vCPU (Benchmark 1 base)</td></tr><tr><td>2</td><td>Multi-destination: 3 outputs → ×0.70 (2 × 15% deduction)</td><td>116 × 0.70 = 81 GB/day per vCPU effective</td></tr><tr><td>3</td><td>Raw vCPUs: 20,000 GB/day ÷ 81 GB/day per vCPU</td><td>247 → round up to 256 vCPUs</td></tr><tr><td>4</td><td>2× peak buffer: 256 × 2</td><td>512 vCPUs peak</td></tr><tr><td>5</td><td>+20% redundancy: 512 × 1.2</td><td>614 vCPUs total provisioned</td></tr><tr><td>6</td><td>Node sizing: Intel c7i.4xlarge (16 vCPUs, 32 GB RAM). 1 vCPU OS reserve → 15 usable. 614 ÷ 15 = 40.9</td><td>41× c7i.4xlarge nodes (656 usable vCPUs, 1.5 TB RAM pool)</td></tr><tr><td>7</td><td>RAM check: Tier 3 = 4–6 GB/vCPU. At 4 GB/vCPU: 15 × 4 = 60 GB per node. c7i.4xlarge provides 32 GB.</td><td>Upgrade to c7i.8xlarge (32 vCPUs, 64 GB RAM). 614 ÷ 31 = 19.8 → 20 nodes.</td></tr><tr><td>8</td><td>Final: 20× c7i.8xlarge (31 usable per node × 20 = 620 vCPUs, 64 GB RAM per node)</td><td>20× c7i.8xlarge worker nodes. RAM check: 31 × 4 GB = 124 GB needed vs. 64 GB available — use c7i.16xlarge (64 vCPUs, 128 GB). 614 ÷ 63 = 10 nodes.</td></tr><tr><td>9</td><td>Final verified: 10× c7i.16xlarge (64 vCPUs, 128 GB RAM). 63 usable × 10 = 630 vCPUs.</td><td>10× c7i.16xlarge worker nodes (630 usable vCPUs, 1.4 TB RAM). Throughput verified: 630 × 81 = 51,030 GB/day — covers 20 TB/day with peak + HA headroom.</td></tr></tbody></table>
...
<table data-header-hidden><thead><tr><th valign="middle"></th><th></th><th></th><th></th><th></th></tr></thead><tbody><tr><td valign="middle"><strong>Daily ingest volume</strong></td><td><strong>Ingest vCPUs*</strong></td><td><strong>AWS Intel nodes (ingest tier)</strong></td><td><strong>Ingest RAM (2 GB/vCPU)</strong></td><td><strong>Includes Core components (static, all volumes)†</strong></td></tr><tr><td valign="middle">50 GB/day</td><td>1 vCPU</td><td>2× c7i.2xlarge</td><td>~2 GB</td><td>10 vCPU + 28 GB RAM + 150 GB disk</td></tr><tr><td valign="middle">100 GB/day</td><td>2 vCPUs</td><td>2× c7i.2xlarge</td><td>~4 GB</td><td>10 vCPU + 28 GB RAM + 150 GB disk</td></tr><tr><td valign="middle">250 GB/day</td><td>4 vCPUs</td><td>2× c7i.2xlarge</td><td>~8 GB</td><td>10 vCPU + 28 GB RAM + 150 GB disk</td></tr><tr><td valign="middle">500 GB/day</td><td>7 vCPUs</td><td>3× c7i.2xlarge</td><td>~21 GB</td><td>10 vCPU + 28 GB RAM + 150 GB disk</td></tr><tr><td valign="middle">1 TB/day</td><td>15 vCPUs</td><td>4× c7i.2xlarge</td><td>~30 GB</td><td>10 vCPU + 28 GB RAM + 150 GB disk</td></tr><tr><td valign="middle">2 TB/day</td><td>29 vCPUs</td><td>3× c7i.4xlarge</td><td>~58 GB</td><td>10 vCPU + 28 GB RAM + 150 GB disk</td></tr><tr><td valign="middle">5 TB/day</td><td>74 vCPUs</td><td>6× c7i.4xlarge</td><td>~148 GB</td><td>10 vCPU + 28 GB RAM + 150 GB disk</td></tr><tr><td valign="middle">10 TB/day</td><td>146 vCPUs</td><td>10× c7i.4xlarge</td><td>~292 GB</td><td>10 vCPU + 28 GB RAM + 150 GB disk</td></tr></tbody></table>
...
<table data-header-hidden><thead><tr><th valign="middle"></th><th></th><th></th><th></th><th></th><th></th></tr></thead><tbody><tr><td valign="middle"><strong>Daily ingest volume</strong></td><td><strong>Ingest vCPUs*</strong></td><td><strong>AWS Intel nodes (ingest tier)</strong></td><td><strong>Ingest RAM (4 GB/vCPU†)</strong></td><td><strong>Disk — ingest pods (B2 only)‡</strong></td><td><strong>Includes Core components (static, all volumes)§</strong></td></tr><tr><td valign="middle">50 GB/day</td><td>3 vCPUs</td><td>2× c7i.2xlarge</td><td>~12 GB</td><td>5 GB min 50 GB rec</td><td>10 vCPU + 28 GB RAM + 150 GB disk</td></tr><tr><td valign="middle">100 GB/day</td><td>5 vCPUs</td><td>2× c7i.2xlarge</td><td>~20 GB</td><td>10 GB min 100 GB rec</td><td>10 vCPU + 28 GB RAM + 150 GB disk</td></tr><tr><td valign="middle">250 GB/day</td><td>12 vCPUs</td><td>3× c7i.2xlarge</td><td>~48 GB</td><td>20 GB min 200 GB rec</td><td>10 vCPU + 28 GB RAM + 150 GB disk</td></tr><tr><td valign="middle">500 GB/day</td><td>24 vCPUs</td><td>2× c7i.4xlarge</td><td>~92 GB</td><td>40 GB min 400 GB rec</td><td>10 vCPU + 28 GB RAM + 150 GB disk</td></tr><tr><td valign="middle">1 TB/day</td><td>48 vCPUs</td><td>4× c7i.4xlarge</td><td>~192 GB</td><td>80 GB min 800 GB rec</td><td>10 vCPU + 28 GB RAM + 150 GB disk</td></tr><tr><td valign="middle">2 TB/day</td><td>96 vCPUs</td><td>7× c7i.4xlarge</td><td>~384 GB</td><td>160 GB min ~1.6 TB rec</td><td>10 vCPU + 28 GB RAM + 150 GB disk</td></tr><tr><td valign="middle">5 TB/day</td><td>240 vCPUs</td><td>16× c7i.4xlarge</td><td>~960 GB</td><td>395 GB min ~4.0 TB rec</td><td>10 vCPU + 28 GB RAM + 150 GB disk</td></tr><tr><td valign="middle">10 TB/day</td><td>480 vCPUs</td><td>31× c7i.4xlarge</td><td>~1.9 TB</td><td>785 GB min ~7.8 TB rec</td><td>10 vCPU + 28 GB RAM + 150 GB disk</td></tr></tbody></table>
