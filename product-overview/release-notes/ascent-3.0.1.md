...
_**What's New**_: A built-in AI assistant, an open door for your own AI tools via MCP, a new Kafka destination, and a long list of fixes and quality-of-life improvements across every part of the platform.

## Release Highlights

Three (3) key features in this release are worth slowing down for - Venn AI Assistant, MCP Server, and Kafka Forwarding.
...
Observe gets its own Venn integration, plus additional Data Explorer and dashboard enhancements.
