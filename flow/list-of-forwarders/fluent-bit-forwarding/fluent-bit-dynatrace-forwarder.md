# Fluent-bit Dynatrace Forwarder

### How to Forward logs from Apica Ascent to Dynatrace using Fluent-bit

#### 1. Introduction

This guide explains how to forward logs from Apica Ascent to Dynatrace using the HTTP input and output plugins with Fluent-bit, and how to view them.
...
If logs are not arriving in Dynatrace verify that the URL, URI and auth token are correct
