...
In this example we use the [HTTP](https://docs.apica.io/integrations/list-of-integrations/fluent-bit/fluent-bit-http-input-plugin) input plugin, Modify filter and the nrlogs output.
...
If your New Relic environment is in the US the Base\_uri field is not required as that is the default value, if your environment is in Europe you need to include the Base\_uri field with the url above.
